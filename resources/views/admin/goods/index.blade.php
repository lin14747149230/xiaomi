	     ...
	     <div class="row">
            ...
            <thead>
                <tr role="row">
                	...
                	<th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="width: 202px;">商品标题</th>
                	<th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 184px;">商品价格</th>
                	<th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending" style="width: 151px;">库存</th>
            ...
            <tbody>
            	@if(count($goods) > 0)
		            ...
		            <tr class="gradeA odd" role="row">
			            ...
			            <td>{{$v->goods_tit}}</td>
			            <td>{{$v->goods_price}}</td>
			            <td class="center">{{$v->goods_kucun}}</td>
			            <td class="center">
			            	<a class="btn btn-danger pull-left" href="/goods/{{$v->goods_id}}/edit">修改</a>
			            		<form class="del" action="/goods/{{$v->goods_id}}" method="post">
			            		{{method_field('DELETE')}}
			            		{{csrf_field()}}
